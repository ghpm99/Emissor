...
public class RelatorioCTE {
    ...
    private void abrir() {
        ...
        try {
            ...
            Logger.getLogger(RelatorioCTE.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    private void carregar(File file) {
        ...
        try {
            ...
            Namespace name = Namespace.getNamespace("http://www.portalfiscal.inf.br/cte");
            ...
            while (itera.hasNext()) {
                try {
                    ...
                    Element valor = linha.getChild("infCte", name);
                    ...
                    String nNota = ide.getChildText("nCT", name);
